from rest_framework import response, viewsets, status, pagination, permissions
from rest_framework.settings import api_settings


def general_response(results=None, response_status=status.HTTP_200_OK, headers=None):
