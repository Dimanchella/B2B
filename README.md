...
- главное меню: Каталог товаров, Заказы

1C:

- подсистема web_Django, синоним: Личный кабинет контрагента
- обработка web_Администрирование, синоним: Администрирование (ошибка Админитсрирование)
