...
Функция СформироватьДанныеЗаказа(СсылкаНаОбъект, ПолнаяВыгрузка)
	...
	Данные.Вставить("number",		web_ОбщегоНазначенияПовтИсп.ДобавитьЗначение(ВыборкаЗаказ.Номер));
	Данные.Вставить("date_time", 	web_ОбщегоНазначенияПовтИсп.ДобавитьЗначение(ВыборкаЗаказ.Дата));
	Данные.Вставить("partner", 		web_ОбщегоНазначенияПовтИсп.ДобавитьЗначение(ВыборкаЗаказ.Партнер));	
	Данные.Вставить("contractor", 	web_ОбщегоНазначенияПовтИсп.ДобавитьЗначение(ВыборкаЗаказ.Контрагент));	
	Данные.Вставить("organization", web_ОбщегоНазначенияПовтИсп.ДобавитьЗначение(ВыборкаЗаказ.Организация));	
	Данные.Вставить("agreement", 	web_ОбщегоНазначенияПовтИсп.ДобавитьЗначение(ВыборкаЗаказ.Соглашение));
	Данные.Вставить("contract", 	web_ОбщегоНазначенияПовтИсп.ДобавитьЗначение(ВыборкаЗаказ.Договор));	
	
	ВыборкаТЧ = ВыборкаЗаказ.Товары.Выбрать();	
	ДанныеТЧ = Новый Массив;
	Пока ВыборкаТЧ.Следующий() Цикл
		СтрокаТЧ = Новый Соответствие;
		СтрокаТЧ.Вставить("product",		web_ОбщегоНазначенияПовтИсп.ДобавитьЗначение(ВыборкаТЧ.Номенклатура));
		СтрокаТЧ.Вставить("characteristic", web_ОбщегоНазначенияПовтИсп.ДобавитьЗначение(ВыборкаТЧ.Характеристика));
		СтрокаТЧ.Вставить("price", 			web_ОбщегоНазначенияПовтИсп.ДобавитьЗначение(ВыборкаТЧ.Цена));	
		СтрокаТЧ.Вставить("quantity", 		web_ОбщегоНазначенияПовтИсп.ДобавитьЗначение(ВыборкаТЧ.Количество));	
		СтрокаТЧ.Вставить("total", 			web_ОбщегоНазначенияПовтИсп.ДобавитьЗначение(ВыборкаТЧ.Сумма));
