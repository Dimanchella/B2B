...
Функция ПолучитьСвязанныеСсылки(СсылкаНаОбъект) Экспорт
	...
	web_ОбщегоНазначения.ЗаписатьЗависимыеСсылкиПоОбъекту(Выборка.Контрагент, СписокСсылок, МаксимальныйПриоритет);
	web_ОбщегоНазначения.ЗаписатьЗависимыеСсылкиПоОбъекту(Выборка.Организация, СписокСсылок, МаксимальныйПриоритет);
