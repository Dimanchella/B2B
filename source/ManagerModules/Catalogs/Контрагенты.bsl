...
Процедура ВставитьДоговоры(Контрагент, СписокПриемник, Приоритет)
	...
	Пока Выборка.Следующий() Цикл
		...
		web_ОбщегоНазначенияПовтИсп.ЗаписатьЗависимыеСсылкиПоОбъекту(Выборка.Организация, СписокПриемник, МаксимальныйПриоритет);
		web_ОбщегоНазначенияПовтИсп.ЗаписатьЗависимыеСсылкиПоОбъекту(Выборка.Партнер, СписокПриемник, МаксимальныйПриоритет);
