...
Функция ПолучитьСвязанныеСсылки(СсылкаНаОбъект) Экспорт
	...
	web_ОбщегоНазначенияПовтИсп.ЗаписатьЗависимыеСсылкиПоОбъекту(Выборка.Родитель, СписокСсылок, МаксимальныйПриоритет);
	Если Выборка.ЭтоГруппа Тогда
		СписокСсылок.Вставить(СсылкаНаОбъект, МаксимальныйПриоритет + 1);
		Возврат СписокСсылок;
	КонецЕсли;
	
	web_ОбщегоНазначенияПовтИсп.ЗаписатьЗависимыеСсылкиПоОбъекту(Выборка.ВидНоменклатуры, СписокСсылок, МаксимальныйПриоритет);
